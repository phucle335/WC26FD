    ...
    const checks = [
      ...
      },
      {
        ...
        run() {
          ...
          const localMode = typeof deps.isLocalDataMode === "function" && deps.isLocalDataMode();
          ...
          return {
            ok: false,
            detail: localMode
              ? "Dữ liệu CỤC BỘ quá cũ, thử fetch ESPN trực tiếp"
              : "Dữ liệu CỤC BỘ quá cũ, thử fetch ESPN lại",
            fix() {
